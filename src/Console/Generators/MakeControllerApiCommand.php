...
class MakeControllerApiCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:module:controller-api
    ...
    {
        return module_class($this->argument('slug'), 'Http\\Controllers\\Api');
    }
}
